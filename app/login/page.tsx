...
return (
  ...
  <section className="grid min-h-[calc(100vh-1rem)] w-full gap-4 md:min-h-[calc(100vh-1.5rem)] lg:min-h-[calc(100vh-2rem)] lg:grid-cols-[1fr_0.9fr]">      <div className="hidden rounded-[2rem] bg-gray-950 p-8 text-white shadow-xl lg:flex lg:flex-col lg:justify-between xl:p-10">
        <div>
          ...
          <div className="mt-16">
            ...
            <p className="mt-5 max-w-xl text-lg leading-8 text-gray-300">
              Log in to update your profile, manage packages, and follow up with
              new client requests.
            </p>
          </div>
        </div>
      ...
      <div className="flex rounded-[2rem] bg-white p-4 shadow-xl md:p-8 lg:items-center lg:justify-center xl:p-10">
        <div className="w-full max-w-md">
          ...
          <div className="mt-8">
            ...
            <h1 className="mt-2 text-4xl font-black tracking-tight">Log in</h1>
